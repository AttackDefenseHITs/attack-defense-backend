package ru.hits.attackdefenceplatform.business.deploy.status;

import jakarta.annotation.PostConstruct;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;
import ru.hits.attackdefenceplatform.business.deploy.repository.DeploymentStatusEntity;
import ru.hits.attackdefenceplatform.business.deploy.repository.DeploymentStatusRepository;
import ru.hits.attackdefenceplatform.business.deploy.status.mapper.DeploymentStatusInitializer;
import ru.hits.attackdefenceplatform.business.virtual_machine.mapper.VirtualMachineMapper;
import ru.hits.attackdefenceplatform.business.vulnerable_service.mapper.VulnerableServiceMapper;
