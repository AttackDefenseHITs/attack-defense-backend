...
import ru.hits.attackdefenceplatform.business.competition.state.impl.CancelledCompetitionState;
import ru.hits.attackdefenceplatform.business.competition.state.impl.CompletedCompetitionState;
import ru.hits.attackdefenceplatform.business.competition.state.impl.InProgressCompetitionState;
import ru.hits.attackdefenceplatform.business.competition.state.impl.NewCompetitionState;
import ru.hits.attackdefenceplatform.business.competition.state.impl.PausedCompetitionState;
